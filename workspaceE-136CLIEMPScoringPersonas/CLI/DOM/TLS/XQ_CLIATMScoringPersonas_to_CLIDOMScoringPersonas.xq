(:: pragma bea:global-element-parameter parameter="$getScoringInternoPersonasResponse1" element="ns2:getScoringInternoPersonasResponse" location="../../ATM/WS/XMLSchemaConsultarScoringInterno.xsd" ::)
...
xf:XQ_CLIATMScoringPersonas_to_CLIDOMScoringPersonas($getScoringInternoPersonasResponse1)