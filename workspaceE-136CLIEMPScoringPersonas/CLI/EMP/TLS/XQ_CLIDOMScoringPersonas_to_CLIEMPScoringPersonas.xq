(:: pragma bea:global-element-parameter parameter="$respScoringPersonas1" element="ns1:respScoringPersonas" location="../../DOM/WS/CLIDOMScoringPersonaResponse.xsd" ::)
...
xf:XQ_CLIDOMScoringPersonas_to_CLIEMPScoringPersonas($respScoringPersonas1)