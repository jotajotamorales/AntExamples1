(:: pragma bea:global-element-parameter parameter="$respValidarEstadoCedula1" element="ns2:respValidarEstadoCedula" location="../../DOM/WS/CLIDOMValidarCedulaResponse.xsd" ::)
...
xf:XQ_CLIDOMValidarCedula_to_CLIEMPValidarCedula($respValidarEstadoCedula1)