(:: pragma bea:global-element-parameter parameter="$validarCedula1" element="ns0:ValidarCedula" location="../WS/CLIEMPValidarCedula.wsdl" ::)
...
xf:XQ_CLIEMPValidarCedula_to_CLIDOMValidarCedula($validarCedula1)