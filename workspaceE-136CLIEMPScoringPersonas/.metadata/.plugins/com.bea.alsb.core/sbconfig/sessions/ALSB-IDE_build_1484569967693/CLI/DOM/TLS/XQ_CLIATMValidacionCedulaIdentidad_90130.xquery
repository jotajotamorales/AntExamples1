...
<con:xqueryEntry xmlns:con="http://www.bea.com/wli/sb/resources/config">
    <con:xquery><![CDATA[(:: pragma bea:global-element-parameter parameter="$validarClienteExternoResponse1" element="ns0:ValidarClienteExternoResponse" location="../../ATM/WS/validarClienteExterno.wsdl" ::)
...
xf:XQ_CLIATMValidacionCedulaIdentidad_to_CLIDOMValidarCedula($validarClienteExternoResponse1)]]></con:xquery>
    <con:dependency location="../../ATM/WS/validarClienteExterno.wsdl">
        <con:wsdl ref="CLI/ATM/WS/validarClienteExterno"/>
    </con:dependency>
    <con:dependency location="../WS/CLIDOMValidarCedulaResponse.xsd">
