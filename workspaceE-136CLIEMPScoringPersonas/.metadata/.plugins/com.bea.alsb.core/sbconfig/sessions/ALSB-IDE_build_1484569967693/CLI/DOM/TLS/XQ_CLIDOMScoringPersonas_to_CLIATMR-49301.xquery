...
<con:xqueryEntry xmlns:con="http://www.bea.com/wli/sb/resources/config">
    <con:xquery><![CDATA[(:: pragma bea:global-element-return element="ns0:setLogScoring" location="../../ATM/WS/XMLSchemaRegistrarLogScoring.xsd" ::)
...
xf:XQ_CLIDOMScoringPersonas_to_CLIATMRegistrarLogScoring($rutCliente,
    ...
    $origenScoring)]]></con:xquery>
    <con:dependency location="../../ATM/WS/XMLSchemaRegistrarLogScoring.xsd">
        <con:schema ref="CLI/ATM/WS/XMLSchemaRegistrarLogScoring"/>
    </con:dependency>
</con:xqueryEntry>